...
public class StaionManagerController implements Initializable {
	   ...
	   @FXML
	    ...
	    void NewReports(ActionEvent event) {
	    	newReports = new NewReportsController();
	    	runLater(() -> {
	    		newReports.start(splitpane, user, "User");
   });
	    }
	    @FXML
	    void OrderConfirmation(ActionEvent event) {
	    	orderConfirmation = new OrderConfirmationController();
	    	runLater(() -> {
	    		orderConfirmation.start(splitpane, user, "User");
   });
	    }
	...
	public static NewReportsController newReports;
	public static OrderConfirmationController orderConfirmation;
